...
setwd("/Users/simon/Documents/repo/SEQ-CO2_für_Walid")

# read data
cant <- st_read("geoDaten/swisstlmregio_2022_2056/swissTLMRegio_Boundaries_LV95/swissTLMRegio_KANTONSGEBIET_LV95.shp")
...
muni <- st_read("geoDaten/plz_verzeichnis_v2/plz_verzeichnis_v2.shp")
resp <- read_xlsx("DatenUmfrage/VoteJune21_June 17, 2021_14.06.xlsx")
...
dat <- resp_merg
save(dat, file = "DatenUmfrage/dat_with_stations_3.RData")
